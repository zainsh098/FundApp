...
class TransactionDataSource() {
    ...
    suspend fun getAllUsers(): List<User> {
        return firestore.collection(TransactionConstant.KEY_O3).document("Users")
            .collection("userIds")
    ...
    suspend fun updateUserBalance(user: User) {
        firestore.collection(TransactionConstant.KEY_O3).document("Users").collection("userIds")
    ...
    suspend fun depositAmount(transaction: TransactionUser) {
        firestore.collection(TransactionConstant.KEY_O3).document("Transactions")
    ...
    suspend fun getTransactionHistoryData(userId: String): List<TransactionUser> {
        return firestore.collection(TransactionConstant.KEY_O3).document("Transactions")
            .collection("transactionIds")
